  ...
  return (
    <div className="flex p-5 w-full overflow-hidden">
      <Slider {...settings}>
        ...
        <div
          className="bg-white border-2 rounded-lg flex flex-col  mr-4 items-start  justify-evenly py-5 px-3 min-w-40 h-52 shadow-lg">
              <img className="w-11 h-11" src={DoorToDoo} alt="imports" />
              <p className="bold-text">Testing 123</p>
            </div>
            <div  className="bg-white border-2 rounded-lg flex flex-col  mr-4 items-start  justify-evenly py-5 px-3 min-w-40 h-52 shadow-lg">
              <img className="w-11 h-11" src={DoorToDoo} alt="imports" />
              <p className="bold-text">Testing 123</p>
            </div>
            <div  className="bg-white text-black border-2 rounded-lg flex flex-col  mr-4 items-start  justify-evenly py-5 px-3 min-w-40 h-52 shadow-lg">
              <img className="w-11 h-11" src={DoorToDoo} alt="imports" />
              <p className="bold-text">Testing 123</p>
            </div>
            <div  className="bg-white border-2 rounded-lg flex flex-col  mr-4 items-start  justify-evenly py-5 px-3 min-w-40 h-52 shadow-lg">
